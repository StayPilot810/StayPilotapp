...
export const heroTranslations: Record<Locale, HeroCopy> = {
  fr: {
    ...
    eventsSummaryTitle: 'Événements autour du logement (juillet, rayon 12 km)',
    eventsSummarySubtitle: 'Base logement : 48.8566, 2.3522 (Paris centre)',
    premiumSignalsLine: 'Notre IA analyse les événements locaux pour optimiser vos prix automatiquement.',
    chipCity: 'Paris',
    chipEvents: 'Événements',
    chipRevenue: 'Revenus',
    estimatedRevenueHeadline: '💰 +420€ de revenus estimés en juillet',
    strongOpportunityBadge: '🔥 Opportunité forte',
    applyOptimizationsCta: 'Appliquer automatiquement ces optimisations',
    closeDropdownCta: "Fermer l'onglet déroulant",
    localEvents: [
      {
        title: 'Paris Plages - 1.0 à 4.8 km',
        action: 'Recommandation : +9% tarif',
        estimatedImpact: '+70€ estimés',
      },
      {
        title: 'Fete nationale (13-14 juillet) - 4.1 km',
        action: 'Recommandation : +18% tarif',
        estimatedImpact: '+120€ estimés',
        strongOpportunity: true,
      },
      {
        title: 'Finale Tour de France - 3.4 km',
        action: 'Recommandation : +15% tarif',
        estimatedImpact: '+95€ estimés',
        strongOpportunity: true,
      },
      {
        title: "Festival Paris l'Été - 0.8 à 3.0 km",
        action: 'Recommandation : +10% tarif',
        estimatedImpact: '+65€ estimés',
      },
      {
        title: 'Cinema en plein air La Villette - 5.3 km',
        action: 'Recommandation : +8% tarif',
        estimatedImpact: '+45€ estimés',
      },
      {
        title: "Grandes expositions d'été - 1.5 à 3.2 km",
        action: 'Recommandation : +7% tarif',
        estimatedImpact: '+25€ estimés',
      },
    ],
  },
  es: {
    ...
    targetApartmentLabel: 'Dirección: 10 Rue de Rivoli, 75001 Paris',
    gpsLabel: 'GPS: 48.8566, 2.3522',
    ...
    premiumSignalsLine: 'Nuestra IA analiza los eventos locales para optimizar tus precios automáticamente.',
    chipCity: 'Paris',
    chipEvents: 'Eventos',
    chipRevenue: 'Ingresos',
    estimatedRevenueHeadline: '💰 +420€ de ingresos estimados en julio',
    strongOpportunityBadge: '🔥 Oportunidad fuerte',
    applyOptimizationsCta: 'Aplicar automáticamente estas optimizaciones',
  ...
  de: {
    ...
    chipEvents: 'Events',
    chipRevenue: 'Umsatz',
    estimatedRevenueHeadline: '💰 +420€ geschätzter Mehrumsatz im Juli',
    strongOpportunityBadge: '🔥 Starke Chance',
    applyOptimizationsCta: 'Diese Optimierungen automatisch anwenden',
    closeDropdownCta: 'Dropdown schließen',
    localEvents: [
      {
        title: 'Paris Plages - 1.0 bis 4.8 km',
        action: 'Erhöhen Sie Ihren Preis um +9%',
        estimatedImpact: '+70€ geschätzt',
      },
      {
        title: 'Nationalfeiertag (13.-14. Juli) - 4.1 km',
        action: 'Erhöhen Sie Ihren Preis um +18%',
        estimatedImpact: '+120€ geschätzt',
        strongOpportunity: true,
      },
      {
        title: 'Tour-de-France-Finale - 3.4 km',
        action: 'Erhöhen Sie Ihren Preis um +15%',
        estimatedImpact: '+95€ geschätzt',
        strongOpportunity: true,
      },
      {
        title: "Festival Paris l'Ete - 0.8 bis 3.0 km",
        action: 'Erhöhen Sie Ihren Preis um +10%',
        estimatedImpact: '+65€ geschätzt',
      },
      {
        title: 'Open-Air-Kino La Villette - 5.3 km',
        action: 'Erhöhen Sie Ihren Preis um +8%',
        estimatedImpact: '+45€ geschätzt',
      },
      {
        title: 'Große Sommerausstellungen - 1.5 bis 3.2 km',
        action: 'Erhöhen Sie Ihren Preis um +7%',
        estimatedImpact: '+25€ geschätzt',
      },
    ],
  },
  it: {
    ...
    strongOpportunityBadge: '🔥 Opportunità alta',
