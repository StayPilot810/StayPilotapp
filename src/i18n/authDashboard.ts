...
export const authDashboardTranslations: Record<Locale, AuthDashboardCopy> = {
  fr: {
    ...
    dashboardChannelHelpBody:
      'Si vous avez un channel manager, connectez vos nouveaux logements à vos channels. Les logements remonteront ensuite automatiquement sur votre compte StayManager.',
