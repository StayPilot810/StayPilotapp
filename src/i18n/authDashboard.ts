...
export type AuthDashboardCopy = {
  ...
  /** Prestataire : texte avant le nom de l'hôte (ex. « Vous êtes invité par »). */
  dashboardCleanerInvitedPrefix: string
  /** Prestataire : libellé si l'hôte n'est pas résolu (ex. « votre hôte »). */
  dashboardCleanerInvitedUnknownHost: string
...
export const authDashboardTranslations: Record<Locale, AuthDashboardCopy> = {
  fr: {
    ...
    dashboardCleanerInvitedPrefix: 'Vous êtes invité par',
    dashboardCleanerInvitedUnknownHost: 'votre hôte',
    ...
    dashboardConnectConnected: 'Connecté',
    dashboardConnectPending: 'Non connecté',
    dashboardConnectAction: 'Connecter',
    dashboardConnectFailed: 'Connexion échouée, vérifiez les champs.',
    ...
    dashboardConnectionsOverviewSubtitle: "Visualisez en un coup d'œil Airbnb, Booking et Channel Manager.",
    dashboardConnectionsColumnPlatform: 'Plateforme',
    dashboardConnectionsColumnStatus: 'Statut',
    dashboardConnectionsAllListings: 'Toutes les annonces connectées',
    ...
    dashboardSummaryConnectedCount: 'Logements connectés',
    dashboardSummaryShowListings: 'Voir tous les logements connectés',
    dashboardSummaryNoListings: 'Aucun logement connecté pour le moment',
  ...
  en: {
    ...
    dashboardActiveOffer: 'Active offer: you currently have', dashboardCleanerInvitedPrefix: 'You are invited by', dashboardCleanerInvitedUnknownHost: 'your host', dashboardCurrentPlan: 'Current plan', dashboardTitle: 'StayPilot Dashboard', dashboardTabsTitle: 'Main tabs',
  ...
  es: {
    ...
    dashboardActiveOffer: 'Oferta activa: actualmente tienes', dashboardCleanerInvitedPrefix: 'Has sido invitado por', dashboardCleanerInvitedUnknownHost: 'tu anfitrión', dashboardCurrentPlan: 'Plan actual', dashboardTitle: 'Dashboard StayPilot', dashboardTabsTitle: 'Pestañas principales',
  ...
  de: {
    ...
    dashboardActiveOffer: 'Aktives Angebot: Sie haben aktuell', dashboardCleanerInvitedPrefix: 'Sie wurden eingeladen von', dashboardCleanerInvitedUnknownHost: 'Ihrem Gastgeber', dashboardCurrentPlan: 'Aktueller Tarif', dashboardTitle: 'StayPilot Dashboard', dashboardTabsTitle: 'Hauptbereiche',
  ...
  it: {
    ...
    dashboardActiveOffer: 'Offerta attiva: attualmente hai', dashboardCleanerInvitedPrefix: 'Sei invitato da', dashboardCleanerInvitedUnknownHost: 'il tuo host', dashboardCurrentPlan: 'Piano attuale', dashboardTitle: 'Dashboard StayPilot', dashboardTabsTitle: 'Schede principali',
