...
export const authDashboardTranslations: Record<Locale, AuthDashboardCopy> = {
  fr: {
    ...
    loginTitle: 'Accédez à votre espace StayManager',
    ...
    signupTrustUsers: '+500 propriétaires utilisent déjà StayManager',
    ...
    dashboardTitle: 'Dashboard StayManager',
    ...
    dashboardReservationAccessSubtitle: 'Renseignez vos acces pour recuperer automatiquement les reservations.',
    ...
    dashboardRequiredLinksTitle: 'Liens et acces necessaires',
    ...
    dashboardRequiredLinksChannelManager: 'Channel Manager: URL webhook + cle API de synchronisation',
    dashboardSaveConnections: 'Enregistrer les connexions',
    dashboardChannelHelpTitle: 'Comment ca fonctionne ?',
    dashboardChannelHelpBody:
      'Si vous avez un channel manager, connectez vos nouveaux logements a vos channels. Les logements remonteront ensuite automatiquement sur votre compte StayManager.',
    dashboardChannelPlanLimit:
      'Si votre offre est inferieure au nombre de logements connectes sur votre channel manager, les derniers appartements ajoutes ne seront pas pris en compte.',
    dashboardSummaryTitle: 'Recapitulatif des logements connectes',
    ...
    dashboardReservationsTitle: 'Informations des reservations',
    dashboardReservationsSubtitle: 'Toutes les donnees recuperees pour chaque reservation connectee.',
  ...
  en: {
    loginBack: '← Back to main menu', loginTitle: 'Access your StayManager space', loginAccountsDetectedNone: 'No account detected yet. Create one first via Sign up.',
    ...
    signupTrustSupplies: 'Supplies and purchases tracking to avoid stockouts', signupTrustHours: 'Up to 8h saved per week on admin and follow-ups', signupTrustUsers: '500+ owners already use StayManager',
    ...
    dashboardActiveOffer: 'Active offer: you currently have', dashboardCurrentPlan: 'Current plan', dashboardTitle: 'StayManager Dashboard', dashboardTabsTitle: 'Main tabs',
  ...
  es: {
    ...
    signupTrustHours: 'Hasta 8h ahorradas por semana en tareas administrativas', signupTrustUsers: '+500 propietarios ya usan StayManager', signupTrustQuote: '"Reducimos imprevistos y ahorramos tiempo cada semana. Por fin una visión clara de rentabilidad."',
    signupPlansTitle: 'Elige tu plan', signupPlansSubtitle: 'Selecciona la mejor oferta antes de crear tu cuenta.',
    dashboardActiveOffer: 'Oferta activa: actualmente tienes', dashboardCurrentPlan: 'Plan actual', dashboardTitle: 'Dashboard StayManager', dashboardTabsTitle: 'Pestañas principales',
    dashboardTabConnect: 'Conectar tus alojamientos', dashboardTabCalendar: 'Calendario', dashboardTabStats: 'Estadísticas de cobro + ocupación', dashboardTabIntel: 'Inteligencia local para tu alojamiento', dashboardTabCleaning: 'Proveedor de limpieza',
  ...
  de: {
    ...
    signupTrustUsers: '500+ Eigentümer nutzen bereits StayManager', signupTrustQuote: '"Wir haben Überraschungen reduziert und jede Woche Zeit gewonnen. Endlich klare Rentabilität."',
    signupPlansTitle: 'Wählen Sie Ihren Plan', signupPlansSubtitle: 'Wählen Sie das passende Angebot vor der Kontoerstellung.',
    dashboardActiveOffer: 'Aktives Angebot: Sie haben aktuell', dashboardCurrentPlan: 'Aktueller Tarif', dashboardTitle: 'StayManager Dashboard', dashboardTabsTitle: 'Hauptbereiche',
    dashboardTabConnect: 'Unterkünfte verbinden', dashboardTabCalendar: 'Kalender', dashboardTabStats: 'Umsatzstatistik + Auslastung', dashboardTabIntel: 'Lokale Informationen für Ihre Unterkunft', dashboardTabCleaning: 'Reinigungsdienst',
  ...
  it: {
    ...
    signupTrustUsers: '+500 proprietari usano già StayManager', signupTrustQuote: '"Abbiamo ridotto gli imprevisti e risparmiato tempo ogni settimana. Finalmente visione chiara della redditività."',
    signupPlansTitle: 'Scegli il tuo piano', signupPlansSubtitle: "Seleziona l'offerta migliore prima di creare l'account.",
    dashboardActiveOffer: 'Offerta attiva: attualmente hai', dashboardCurrentPlan: 'Piano attuale', dashboardTitle: 'Dashboard StayManager', dashboardTabsTitle: 'Schede principali',
    dashboardTabConnect: 'Collega i tuoi alloggi', dashboardTabCalendar: 'Calendario', dashboardTabStats: 'Statistiche incassi + tasso di occupazione', dashboardTabIntel: 'Monitoraggio locale del tuo alloggio', dashboardTabCleaning: 'Fornitore pulizie',
