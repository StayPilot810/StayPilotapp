    ...
    >
      <div className="relative mx-auto max-w-[720px] px-5 text-center sm:px-6">
        ...
        <div className="mt-6 sm:mt-7">
          <a
            href="#"
            className="inline-flex items-center justify-center rounded-full px-8 py-3.5 text-[15px] font-semibold text-white shadow-[0_8px_24px_rgba(74,134,247,0.35)] transition hover:brightness-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4a86f7]/50 focus-visible:ring-offset-2"
