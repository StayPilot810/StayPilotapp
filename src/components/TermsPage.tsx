      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-6 space-y-6 text-[15px] leading-relaxed text-zinc-700 sm:text-base">
            ...
            <div>
              <h2 className="text-lg font-semibold text-zinc-900">Article 5 — Propriété intellectuelle</h2>
              <p className="mt-2">
            ...
            <div>
              <h2 className="text-lg font-semibold text-zinc-900">Article 6 — Limitation de responsabilité</h2>
              <p className="mt-2">
            ...
            <div>
              <h2 className="text-lg font-semibold text-zinc-900">Article 7 — Évolution des CGU</h2>
              <p className="mt-2">
            ...
            <div>
              <h2 className="text-lg font-semibold text-zinc-900">Article 8 — Droit applicable</h2>
              <p className="mt-2">
            ...
            <div>
              <h2 className="text-lg font-semibold text-zinc-900">Article 9 — Contact</h2>
              <p className="mt-2">
